...
const List<String> defaultIpv4Cidrs = [
  '173.245.48.0/20',
  '103.21.244.0/22',
  '103.22.200.0/22',
  '103.31.4.0/22',
...
const List<String> defaultIpv6Cidrs = [
  '2400:cb00::/32',
  '2606:4700::/32',
  '2803:f800::/32',
  '2405:b500::/32',
...
Future<void> ensureIpRangeFiles() async {
  final File v4 = File('./ipv4.txt');
  if (!v4.existsSync()) {
    await v4.writeAsString(defaultIpv4Cidrs.join('\n'));
  }
  final File v6 = File('./ipv6.txt');
  if (!v6.existsSync()) {
    await v6.writeAsString(defaultIpv6Cidrs.join('\n'));
  }
}
